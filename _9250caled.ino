...
//    Serial.print(" gz = "); Serial.print( gz, 2); Serial.println(" deg/s");
   ...
   Serial.print(",  "); 
    ...
    Serial.print(",  "); 
    //Serial.print(" mz = "); 
    Serial.print( (int)mz ); //Serial.println(" mG");
     Serial.println("  "); 
//    
...
//    Serial.print(" qz = "); Serial.println(q[3]); 
  ...
  // For more see http://en.wikipedia.org/wiki/Conversion_between_quaternions_and_Euler_angles which has additional links.
    ...
    pitch *= 180.0f / PI;
    yaw   *= 180.0f / PI; 
    yaw   += 0.8; // Declination at Danville, California is 13 degrees 48 minutes and 47 seconds on 2014-04-04
    roll  *= 180.0f / PI;
     
//    if(SerialDebug) {
//    Serial.print("Yaw, Pitch, Roll: ");
//    Serial.print(yaw, 2);
//    //myservoY.write(int(yaw * 180.0f/M_PI)-146);
//    Serial.print(", ");
//    Serial.print(pitch, 2);
//    //myservoX.write(int(roll * 180.0f/M_PI));
//    Serial.print(", ");
